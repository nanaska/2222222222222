                    ...
                    <ModalContent>
                        ...
                        <ModalBody>
                            <div className="flex relative flex-col items-center justify-center">
                                <div className="mb-2"><Image src={`/Interpreter.png`} width={200} height={200}/>

                                    <div className="mt-2 items-center flex justify-center">
                                        <span className="text-[24px] py-2 font-bold">Официант</span>
                                    </div>
                                </div>
                                <div className="mr-auto text-[18px]">
                                    <h3 className="py-4">Мы в поиске Официанта</h3>
                                </div>
                                <div className="mr-auto mt-3">
                                    <h3 className="text-[16px] font-bold">Обязанности:</h3>
                                    <ul className="ml-6 list-disc">
                                        <li>Обслуживание гостей</li>
                                        <li>Поддерживание чистоты в зале</li>
                                        <li>Создание уютной и гостеприимной атмосферы</li>
                                    </ul>
                                </div>
                                <div className="mr-auto mt-3">
                                    <h3 className="text-[16px] font-bold">Условия:</h3>
                                    <ul className="ml-6 list-disc">
                                        <li>График работы 2/2 с 10:00 до 23:00</li>
                                ...
                                <div className="mr-auto mt-3">
                                    ...
                                    <ul className="ml-6 list-disc">
                                        ...
                                        <li>Умение грамотно разговаривать</li>
                                        <li>Желание зарабатывать и развиваться в ресторанной сфере</li>
                                    </ul>
                                </div>
